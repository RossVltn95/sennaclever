...
[
  ...
  ["remote browser managed surface", 'surface: isNoVncTransport ? "internal_novnc" : "managed_live_browser"'],
  ["remote browser live surface helper", "function isApplyChatLiveBrowserSurface(surface)"],
  ["remote browser surface attribute", "data-sffc-remote-browser-surface"],
  ["remote browser transport attribute", "data-sffc-remote-browser-transport"],
  ["live browser compatibility class", "sffc-crm-apply-results__live-browser"],
...
[
  ...
  ["php localizes remote browser admin-only flag", "'remoteBrowserAdminOnly' => $this->is_crm_apply_chat_remote_browser_admin_only(),"],
  ["php localizes remote browser paying-beta flag", "'remoteBrowserPayingBeta' => $this->is_crm_apply_chat_remote_browser_paying_beta(),"],
  ["php remote browser transport helper", "private function get_crm_apply_chat_remote_browser_transport()"],
  ["php remote browser surface helper", "private function get_crm_apply_chat_remote_browser_surface()"],
  ["php no public novnc helper", "private function can_crm_apply_chat_expose_public_novnc()"],
  ["php remote browser admin-only helper", "private function is_crm_apply_chat_remote_browser_admin_only()"],
  ["php remote browser paying-beta helper", "private function is_crm_apply_chat_remote_browser_paying_beta()"],
  ["php remote browser rollout helper", "private function current_user_can_use_crm_apply_chat_remote_browser_rollout()"],
  ["php no public novnc blocks frontend", "$transport === 'novnc' && !$this->can_crm_apply_chat_expose_public_novnc()"],
  ["php remote browser rollout blocks frontend", "&& $this->current_user_can_use_crm_apply_chat_remote_browser_rollout()"],
  ["php remote browser broker configured transport", "'transport' => $this->get_crm_apply_chat_remote_browser_transport(),"],
  ["php remote browser broker returns surface", "'surface' => $this->get_crm_apply_chat_remote_browser_surface(),"],
  ["php review decision external link surface", "'surface' => 'external_link_only'"],
  ["php review decision external link transport", "'transport' => 'external_link'"],
  ["php review decision managed live surface", "'managed_live_browser'"],
  ["php review decision internal novnc surface", "'internal_novnc'"],
