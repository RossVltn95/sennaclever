...
<?php
    ...
    private function generate_test_message($user)
    {
        ...
        <p>This is a test message from the Matcher-Messaging system. I'm Emily Bradshaw, your Career Success Manager at senna.</p>
    ...
    private function send_onboarding_to_new_users()
    {
        ...
        $users_without_onboarding = $wpdb->get_col("
            ...
            LEFT JOIN $messages_table m ON u.ID = m.recipient_id 
                ...
                AND m.subject LIKE '%Welcome to senna%'
            WHERE m.id IS NULL
            AND u.ID != $emily_id
            LIMIT 50
        ");
        ...
        foreach ($users_without_onboarding as $user_id) {
            ...
            $result = $messaging->send_message([
                ...
                'subject' => 'Welcome to senna - Let\'s Find Your Perfect Role!',
    ...
    private function generate_professional_onboarding($greeting, $first_name)
    {
        ...
        <p>I'm Emily Bradshaw, your dedicated Career Success Manager here at senna. I wanted to personally welcome you and share how excited I am to help accelerate your career in financial services.</p>
    ...
    private function generate_friendly_onboarding($greeting, $first_name)
    {
        ...
        <p>Emily here from senna! So glad you've joined us - I think we're going to do great things together.</p>
    ...
    private function generate_executive_onboarding($greeting, $first_name)
    {
        ...
        <p>I am Emily Bradshaw, Career Success Manager at senna. It is my privilege to personally oversee your career advancement within our exclusive network.</p>
    ...
    private function generate_mentor_onboarding($greeting, $first_name)
    {
        ...
        senna | Always here when you need guidance</p>
        ";
    }
    ...
    private function generate_profile_reminder_message($user)
    {
        ...
        switch ($personality) {
            case 'friendly_casual':
                ...
                <p>Emily here from senna! I hope you're settling in well. I wanted to check in because I've noticed your profile could use some love, and I'm excited to help you get the most out of our platform.</p>
            ...
            default: // professional_warm
                ...
                <p>I hope you're settling in well at senna. As your Career Success Manager, I wanted to personally check in and share some insights that could significantly enhance your experience with us.</p>
