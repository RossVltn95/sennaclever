...
class SFFC_Database_Table_Manager {
    ...
    private function define_tables() {
        ...
        $this->tables['networking_requests'] = array(
            'name' => $wpdb->prefix . 'sffc_networking_requests',
            'sql' => "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}sffc_networking_requests (
            ...
            'description' => 'Stores professional introduction requests between users'
        );
        
        $this->tables['professional_connections'] = array(
            'name' => $wpdb->prefix . 'sffc_professional_connections',
            'sql' => "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}sffc_professional_connections (
                id bigint(20) NOT NULL AUTO_INCREMENT,
            ...
            'description' => 'Stores successful professional connections between users'
        );
        ...
        $this->tables['crm_posts'] = array(
            ...
            'sql' => "CREATE TABLE IF NOT EXISTS {$wpdb->prefix}sffc_crm_posts (
                ...
                response_label varchar(100) DEFAULT NULL,
                response_badge varchar(100) DEFAULT NULL,
                jobseeker_notes text DEFAULT NULL,
                requirements longtext,
                skills_mentioned longtext,
                knockout_questions longtext,
                application_process longtext DEFAULT NULL,
                team_contacts longtext DEFAULT NULL,
                materials longtext DEFAULT NULL,
                keywords longtext DEFAULT NULL,
                experience_years varchar(50),
                recruiter_display_name varchar(255) DEFAULT NULL,
                recruiter_display_company varchar(255) DEFAULT NULL,
