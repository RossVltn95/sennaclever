...
?>
                ...
                <div class="card">
                    ...
                    <div class="sffc-search-actions" style="margin: 20px 0; padding: 15px; background: #f8f9fa; border-radius: 4px;">
                        ...
                        <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                            <button class="button sffc-index-content" data-post-type="sffc_job">
                                <?php esc_html_e('Index Jobs', 'senna-finance'); ?>
                            </button>
    ...
    private function get_search_engine_status()
    {
        ...
        $post_types = array('sffc_job', 'sffc_pe_news', 'sffc_recruiter', 'sffc_company', 'sffc_deal');
        $total_content = 0;
